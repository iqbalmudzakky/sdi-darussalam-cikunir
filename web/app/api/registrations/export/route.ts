...
export async function GET() {
  ...
  try {
    ...
    worksheet.columns = [
      ...
      {
        header: "Tempat Lahir Siswa",
        key: "place_of_birth",
        width: 22,
      },
      {
        header: "Tanggal Lahir Siswa",
        key: "date_of_birth",
        width: 20,
      },
      { header: "Anak ke-", key: "birth_order", width: 12 },
      {
        header: "Jumlah Saudara",
        key: "sibling_count",
        width: 16,
      },
      {
      ...
      {
        header: "Tempat Lahir Ayah",
        key: "father_place_of_birth",
        width: 22,
      },
      {
        header: "Tanggal Lahir Ayah",
        key: "father_date_of_birth",
        width: 20,
      },
      { header: "No. HP Ayah", key: "father_phone", width: 18 },
      {
        header: "Penghasilan Ayah (Rp)",
        key: "father_income",
        width: 22,
      },
      ...
      {
        header: "Tempat Lahir Ibu",
        key: "mother_place_of_birth",
        width: 22,
      },
      {
        header: "Tanggal Lahir Ibu",
        key: "mother_date_of_birth",
        width: 20,
      },
      { header: "No. HP Ibu", key: "mother_phone", width: 18 },
      {
        header: "Penghasilan Ibu (Rp)",
        key: "mother_income",
        width: 22,
      },
      {
    ...
    registrations.forEach((registration, index) => {
      worksheet.addRow({
        ...
        registration_type: getOptionLabel(REGISTRATION_TYPE_OPTIONS, registration.registration_type),
        full_name: registration.full_name,
        student_nik: registration.nik,
        gender: getOptionLabel(GENDER_OPTIONS, registration.gender),
        ...
        physical_disability: getOptionLabel(PHYSICAL_DISABILITY_OPTIONS, registration.physical_disability),
        previous_school: registration.previous_school,
        nisn: registration.nisn ?? "",
        father_status: registration.father_status ? getOptionLabel(PARENT_RELATIONSHIP_OPTIONS, registration.father_status) : "",
        father_name: registration.father_name,
        father_nik: registration.father_nik,
        father_place_of_birth: registration.father_place_of_birth,
        father_date_of_birth: registration.father_date_of_birth ? formatDateOnly(registration.father_date_of_birth) : "",
        father_phone: registration.father_phone,
        father_income: registration.father_income,
        mother_status: registration.mother_status ? getOptionLabel(PARENT_RELATIONSHIP_OPTIONS, registration.mother_status) : "",
        mother_name: registration.mother_name,
        mother_nik: registration.mother_nik,
        mother_place_of_birth: registration.mother_place_of_birth,
        mother_date_of_birth: registration.mother_date_of_birth ? formatDateOnly(registration.mother_date_of_birth) : "",
    ...
    const filename = `data-pendaftar-${getDateStamp()}.xlsx`;
    ...
    return NextResponse.json({ error: "Gagal membuat file Excel data pendaftar." }, { status: 500 });
  }
}
