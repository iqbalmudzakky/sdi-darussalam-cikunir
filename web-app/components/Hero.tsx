        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              SDI Darussalam Cikunir, Bekasi Selatan - Lembaga pendidikan yang
              mengintegrasikan kurikulum nasional dengan nilai-nilai keislaman
              untuk menghasilkan siswa yang unggul dalam prestasi dan karakter.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href="#tentang"
                className="px-8 py-4 bg-white text-emerald-600 rounded-full font-semibold border-2 border-emerald-600 hover:bg-emerald-50 transition-all duration-300 text-center"
              >
